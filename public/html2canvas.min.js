...
!(function (A, e) {
    ...
    ***************************************************************************** */ var r = function (
                                ...
                                B &&
                                    (s =
                                        2 & e[0]
                                            ...
                                            : e[0]
                                            ? B.throw ||
                                              ((s = B.return) && s.call(B), 0)
                                            : B.next) &&
                                    !(s = s.call(B, e[1])).done)
                            )
                                return s
                            switch (
                                ((B = 0), s && (e = [2 & e[0], s.value]), e[0])
                            ) {
                                case 0:
                                case 1:
                                    s = e
                ...
                2 === U[5]
                    ...
                    : (function (A, e, t) {
                          return A.slice
                              ? A.slice(e, t)
                              : new Uint32Array(
                                    Array.prototype.slice.call(A, e, t)
                                )
    ...
    ;((oA = sA || (sA = {}))[(oA.STRING_TOKEN = 0)] = "STRING_TOKEN"),
        ...
        (oA[(oA.RIGHT_SQUARE_BRACKET_TOKEN = 29)] =
        ...
        MA =
            ...
            (yA.prototype.consumeIdentLikeToken = function () {
                ...
                return "url" === A.toLowerCase() && 40 === this.peekCodePoint(0)
                    ...
                    ? (this.consumeCodePoint(),
                      { type: sA.FUNCTION_TOKEN, value: A })
            ...
            (yA.prototype.consumeUrlToken = function () {
                ...
                if (39 === t || 34 === t) {
                    ...
                    return r.type === sA.STRING_TOKEN &&
                        ...
                        ? (this.consumeCodePoint(),
                          { type: sA.URL_TOKEN, value: r.value })
            ...
            (yA.prototype.consumeNumber = function () {
                ...
                return [
                    (function (A) {
                        ...
                        return (
                            t * (n + o * Math.pow(10, -s)) * Math.pow(10, i * c)
                        )
                    })(A),
                    e,
                ]
    ...
    var _A =
        ...
        (PA.prototype.consumeFunction = function (A) {
            for (var e = { name: A.value, values: [], type: sA.FUNCTION }; ; ) {
                ...
                if (
                    t.type === sA.EOF_TOKEN ||
                    t.type === sA.RIGHT_PARENTHESIS_TOKEN
                )
                    return e
                this.reconsumeToken(t),
                    e.values.push(this.consumeComponentValue())
    ...
    function le(A) {
        var e = A.filter(kA),
            ...
            B = e[3],
            s =
                (t.type === sA.NUMBER_TOKEN ? Qe(t.number) : ce(t)) /
                (2 * Math.PI),
                ...
                "number" == typeof A
                    ...
                    : (function (A, e, t) {
                          var r = e / 2,
                              ...
                              s = n - ae(A[1], t)
                          return (
                              (Math.atan2(s, B) + 2 * Math.PI) % (2 * Math.PI)
                          )
                      })(A, e, t),
            ...
            WA(A).forEach(function (A, e) {
                if (0 === e) {
                    ...
                    if (
                        ...
                        -1 !==
                            ["top", "left", "right", "bottom"].indexOf(t.value)
                    )
                        return void (n = Ae(A))
    ...
    var me = {
        ...
        ve = {
            get SUPPORT_RANGE_BOUNDS() {
                ...
                return (
                    Object.defineProperty(ve, "SUPPORT_RANGE_BOUNDS", {
                        value: A,
                    }),
                    A
                )
            ...
            get SUPPORT_SVG_DRAWING() {
                ...
                return (
                    Object.defineProperty(ve, "SUPPORT_SVG_DRAWING", {
                        value: A,
                    }),
                    A
                )
            ...
            get SUPPORT_CORS_IMAGES() {
                ...
                return (
                    Object.defineProperty(ve, "SUPPORT_CORS_IMAGES", {
                        value: A,
                    }),
                    A
                )
            ...
            get SUPPORT_RESPONSE_TYPE() {
                ...
                return (
                    Object.defineProperty(ve, "SUPPORT_RESPONSE_TYPE", {
                        value: A,
                    }),
                    A
                )
            ...
            get SUPPORT_CORS_XHR() {
                ...
                return (
                    Object.defineProperty(ve, "SUPPORT_CORS_XHR", { value: A }),
                    A
                )
            },
        },
    ...
    var kt,
        ...
        er = {
            ...
            prefix: !1,
            parse: function (A) {
                return A.type === sA.IDENT_TOKEN && "none" === A.value
                    ? null
                    : ot(A)
            },
        }
                    ...
                    return (
                        e.forEach(function (A) {
                            if (
                                ...
                                ve.SUPPORT_RANGE_BOUNDS ||
                                    (r = r.splitText(A.length))
                            B += A.length
                        }),
                        n
                    )
                                        ...
                                        return (
                                            ...
                                            s &&
                                                ...
                                                !/(iPad|iPhone|iPod)/g.test(
                                                    ...
                                                    (s.scrollY === t.top &&
                                                        s.scrollX === t.left) ||
                                                    ((o.documentElement.style.top =
                                                        -t.top + "px"),
                                                    (o.documentElement.style.left =
                                                        -t.left + "px"),
                                ...
                                if (A.type === sA.STRING_TOKEN)
                                    ...
                                    if ("attr" === A.name) {
                                        ...
                                        var r = A.values.filter(kA),
                                            ...
                                            B = r[1]
                                        if (n && zA(n)) {
                                            var s = l.counters.getCounterValue(
                                                    n.value
                                                ),
                                                o =
                                                    B && zA(B)
                                        ...
                                        var i = A.values.filter(kA),
                                            a = ((n = i[0]), i[1])
                                        if (((B = i[2]), n && zA(n))) {
                                            var c = l.counters.getCounterValues(
                                                    n.value
                                                ),
                                                Q =
                                                    B && zA(B)
    ...
    function ds(A, e, t) {
        var r = (function (A, e) {
            ...
            o = B[1],
            i = jA(
                ms(A.styles.backgroundPosition, e),
                r.width - s,
                r.height - o
            )
        return [
                            ...
                            A.length &&
                                ...
                                o.textDecorationLine.length &&
                                    ...
                                    o.textDecorationLine.forEach(function (A) {
                                        switch (A) {
                                            case 1:
                                                var e = s.fontMetrics.getMetrics(
                                                    n,
                                                    B
                                                ).baseline
                                                s.ctx.fillRect(
                                            ...
                                            case 2:
                                                ...
                                                break
                                            case 3:
                                                var t = s.fontMetrics.getMetrics(
                                                    n,
                                                    B
                                                ).middle
                                                s.ctx.fillRect(
                        ...
                        case 19:
                            l.listValue &&
                                ...
                                (U = new I(
                                    e.bounds.left,
                                    e.bounds.top +
                                        ae(e.styles.paddingTop, e.bounds.width),
                                    e.bounds.width,
                                    (function (A, e) {
                ...
                return S(this, function (A) {
                    switch (A.label) {
                        case 0:
                            return [
                                4,
                                this.renderNodeBackgroundAndBorders(C.element),
                            ]
                        case 1:
                            A.sent(),
                                (e = 0),
                                            ...
                                            case 5:
                                                !(function (A) {
                                                    ...
                                                    : ((B = ds(b, v, [
                                                      ...
                                                      (w.height = H),
                                                      (u = w.getContext("2d")),
                                                      (U = u.createLinearGradient(
                                                          i,
                                                          c,
                                                          a,
                                                          Q
                                                      )),
                                                      fe(e.stops, o).forEach(
                                                          function (A) {
