    ...
    return (function t(r, s, e) {
    ...
    })(
        {
            ...
            2: [
                function (t, r) {
                    ...
                    function s(t) {
                        ...
                        var s = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(
                            t
                        )
                        return s
                            ? {
            ...
            3: [
                        ...
                        ;(H.prototype.toSvg = function () {
                            ...
                            (H.prototype.generateBackground = function () {
                                ...
                                this.opts.color
                                    ...
                                    : ((r = i(
                                      ...
                                      (o = e(this.hash, 17)),
                                      (t = b.rgb2hsl(
                                          b.hex2rgb(this.opts.baseColor)
                                      )),
                                      (t.h =
                                          ((360 * t.h - r + 360) % 360) / 360),
                                      (t.s =
                                          o % 2 === 0
                                              ? Math.min(
                                                    1,
                            ...
                            (H.prototype.geoSineWaves = function () {
                                var t,
                                    ...
                                    c,
                                    f = Math.floor(
                                        i(e(this.hash, 0), 0, 15, 100, 400)
                                    ),
                                    u = Math.floor(
                                        i(e(this.hash, 1), 0, 15, 30, 100)
                                    ),
                                    p = Math.floor(
                                        i(e(this.hash, 2), 0, 15, 3, 30)
                                    )
                                for (
                                    this.svg.setWidth(f),
                            ...
                            (H.prototype.geoMosaicSquares = function () {
                                var t,
                                    r,
                                    s,
                                    o = i(e(this.hash, 0), 0, 15, 15, 50)
                                for (
                                    this.svg.setWidth(8 * o),
                ...
                { "./color": 2, "./sha1": 4, "./svg": 5, buffer: 7, extend: 8 },
            ],
            4: [
                function (t, r) {
                    "use strict"
                            ...
                            for (t = 0; 80 > t; t++) {
                                20 > t
                                    ? ((s = g ^ (o & (p ^ g))),
                                      (e = 1518500249))
                                    : 40 > t
                                    ? ((s = o ^ p ^ g), (e = 1859775393))
                                    : 60 > t
                                    ? ((s = (o & p) | (g & (o | p))),
                                      (e = 2400959708))
                                    : ((s = o ^ p ^ g), (e = 3395469782))
                                var y =
                                    ((i << 5) | (i >>> 27)) +
                                    s +
                                    v +
                    ...
                    ;(r.exports = s),
                        ...
                        (s.prototype.polyline = function (t, r) {
                            ...
                            return (
                                ...
                                this.setAttributes(o, e({ points: t }, r)),
                                this
                            )
                        }),
